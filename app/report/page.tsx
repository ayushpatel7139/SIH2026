    ...
    <main className="min-h-screen bg-slate-50 pb-20 print:bg-white print:pb-0">
      ...
      <div className="no-print border-b border-[var(--line)] bg-white py-4 sticky top-0 z-50 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="font-extrabold text-[var(--ink)] text-sm flex items-center gap-3 uppercase tracking-widest">
             <div className="flex items-center justify-center w-10 h-10 rounded-xl overflow-hidden bg-white shadow-sm shrink-0 p-1.5">
        ...
        <header className="p-8 sm:p-12 border-b-2 border-slate-900 bg-slate-900 text-white">
          <div className="flex justify-between items-start mb-12">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-extrabold text-white text-3xl uppercase tracking-[0.1em] leading-none mb-1">MIRAI</div>
                <div className="font-medium text-slate-300 text-xs">Advisory Assessment</div>
              </div>
            </div>
